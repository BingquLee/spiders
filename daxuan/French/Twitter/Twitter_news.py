...
def scroll(keyword, scroll_time):
...
def crawl_twitter(keyword, start_strdate, end_strdate):
    ...
    for li in lis:
        ...
        # keyword = Traditional2Simplified(keyword.decode("utf-8"))#关键词
            ...
            item['screen_name'] = screen_name  #昵称
...
if __name__ == '__main__':
    crawl_twitter("Emmanuel Macron", '2017-01-01', '2017-05-07')
    crawl_twitter("Marine Le Pen", '2017-01-01', '2017-05-07')
