...
if __name__ == '__main__':
    # crawl_lianhe('Mostafa Hashemitaba', '2017-01-01', '2017-05-19')
    # crawl_lianhe('Ebrahim Raisi', '2017-01-01', '2017-05-19')
    crawl_lianhe('Hassan Rouhani', '2017-01-01', '2017-05-19')
    crawl_lianhe('Mostafa Mir-Salim', '2017-01-01', '2017-05-19')
