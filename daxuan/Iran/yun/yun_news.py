...
if __name__ == '__main__':
    ...
    # crawl_yun('Viktor Orbán', '2017-01-01')
    # crawl_yun('Gergely Karácsony', '2017-01-01')
    # crawl_yun('Gábor Vona', '2017-01-01')
    # crawl_yun('Bernadett Szél', '2017-01-01')
    # crawl_yun('Ferenc Gyurcsány', '2017-01-01')
    # crawl_yun('Viktor Szigetvári', '2017-01-01')
    crawl_yun('Mostafa Hashemitaba', '2017-01-01', '2017-05-19')
    crawl_yun('Ebrahim Raisi', '2017-01-01', '2017-05-19')
    crawl_yun('Hassan Rouhani', '2017-01-01', '2017-05-19')
    crawl_yun('Mostafa Mir-Salim', '2017-01-01', '2017-05-19')