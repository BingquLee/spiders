...
if __name__ == '__main__':
    ...
    # crawl_yahoo('Viktor Orbán', '2017-01-01')
    # crawl_yahoo('Gergely Karácsony', '2017-01-01')
    # crawl_yahoo('Gábor Vona', '2017-01-01')
    # crawl_yahoo('Bernadett Szél', '2017-01-01')
    # crawl_yahoo('Ferenc Gyurcsány', '2017-01-01')
    # crawl_yahoo('Viktor Szigetvári', '2017-01-01')
