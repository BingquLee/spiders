...
def get_content(urls, keyword, start_timest, end_timest):
    for url in urls:
...
def crawl_ptt(keyword, start_strdate, end_strdate):
    page = 1
    ...
    while 1:
        ...
        get_content(urls, keyword, start_timest, end_timest)
        # for url in urls:
...
if __name__ == '__main__':
    # crawl_ptt('Emmanuel Macron')
    # crawl_ptt('Marine Le Pen')
    crawl_ptt('Angela Merkel', '2017-03-01', '2017-09-24')
    crawl_ptt('Horst Seehofer', '2017-03-01', '2017-09-24')
    crawl_ptt('Martin Schulz', '2017-03-01', '2017-09-24')
    crawl_ptt('Sahra Wagenknecht', '2017-03-01', '2017-09-24')
    crawl_ptt('Dietmar Bartsch', '2017-03-01', '2017-09-24')
    crawl_ptt('Cem Özdemir', '2017-03-01', '2017-09-24')
    crawl_ptt('Katrin Göring-Eckardt', '2017-03-01', '2017-09-24')
    crawl_ptt('Christian Lindner', '2017-03-01', '2017-09-24')
    crawl_ptt('Alexander Gauland', '2017-03-01', '2017-09-24')
    crawl_ptt('Alice Weidel', '2017-03-01', '2017-09-24')
