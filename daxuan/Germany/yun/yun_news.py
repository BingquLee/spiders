...
if __name__ == '__main__':
    # crawl_yun('Emmanuel Macron', '2017-01-01')
    # crawl_yun('Marine Le Pen', '2017-01-01')
    crawl_yun('Angela Merkel', '2017-03-01', '2017-09-24')
    crawl_yun('Horst Seehofer', '2017-03-01', '2017-09-24')
    crawl_yun('Martin Schulz', '2017-03-01', '2017-09-24')
    crawl_yun('Sahra Wagenknecht', '2017-03-01', '2017-09-24')
    crawl_yun('Dietmar Bartsch', '2017-03-01', '2017-09-24')
    crawl_yun('Cem Özdemir', '2017-03-01', '2017-09-24')
    crawl_yun('Katrin Göring-Eckardt', '2017-03-01', '2017-09-24')
    crawl_yun('Christian Lindner', '2017-03-01', '2017-09-24')
    crawl_yun('Alexander Gauland', '2017-03-01', '2017-09-24')
    crawl_yun('Alice Weidel', '2017-03-01', '2017-09-24')