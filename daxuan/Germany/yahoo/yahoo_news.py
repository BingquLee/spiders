...
@retry(tries=3)
def get_content(lis, keyword, start_timest, end_timest):
    i = 1
    for li in lis:
        item = {}
        source = "yahoo"
...
def crawl_yahoo(keyword, start_strdate, end_strdate):
    ...
    while 1:
        ...
        # if len(lis) <= 0:
        #     break
        get_content(lis, keyword, start_timest, end_timest)
        page += 10



if __name__ == '__main__':
    # crawl_yahoo('Emmanuel Macron', '2017-01-01')
    # crawl_yahoo('Marine Le Pen', '2017-01-01')
    crawl_yahoo('Angela Merkel', '2017-03-01', '2017-09-24')
    crawl_yahoo('Horst Seehofer', '2017-03-01', '2017-09-24')
    crawl_yahoo('Martin Schulz', '2017-03-01', '2017-09-24')
    crawl_yahoo('Sahra Wagenknecht', '2017-03-01', '2017-09-24')
    crawl_yahoo('Dietmar Bartsch', '2017-03-01', '2017-09-24')
    crawl_yahoo('Cem Özdemir', '2017-03-01', '2017-09-24')
    crawl_yahoo('Katrin Göring-Eckardt', '2017-03-01', '2017-09-24')
    crawl_yahoo('Christian Lindner', '2017-03-01', '2017-09-24')
    crawl_yahoo('Alexander Gauland', '2017-03-01', '2017-09-24')
    crawl_yahoo('Alice Weidel', '2017-03-01', '2017-09-24')