...
if __name__ == '__main__':
    # crawl_lianhe('Angela Merkel', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Horst Seehofer', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Martin Schulz', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Sahra Wagenknecht', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Dietmar Bartsch', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Cem Özdemir', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Katrin Göring-Eckardt', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Christian Lindner', '2017-03-01', '2017-09-24')
    # crawl_lianhe('Alexander Gauland', '2017-03-01', '2017-09-24')
    crawl_lianhe('Alice Weidel', '2017-03-01', '2017-09-24')