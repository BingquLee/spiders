...
if __name__ == '__main__':
    # crawl_yun('Angela Merkel', '2017-01-01')
    # crawl_yun('Horst Seehofer', '2017-01-01')
    # crawl_yun('Martin Schulz', '2017-01-01')
    # crawl_yun('Sahra Wagenknecht', '2017-01-01')
    # crawl_yun('Dietmar Bartsch', '2017-01-01')
    # crawl_yun('Cem Özdemir', '2017-01-01')
    # crawl_yun('Katrin Göring-Eckardt', '2017-01-01')
    # crawl_yun('Christian Lindner', '2017-01-01')
    # crawl_yun('Alexander Gauland', '2017-01-01')
    # crawl_yun('Alice Weidel', '2017-01-01')


    crawl_yun(urllib.quote('Viktor Orbán','utf-8'), '2017-11-01', '2018-4-08')
    crawl_yun('Gergely Karácsony', '2017-11-01', '2018-4-08')
    crawl_yun('Gábor Vona', '2017-11-01', '2018-4-08')
    crawl_yun('Bernadett Szél', '2017-11-01', '2018-4-08')
    crawl_yun('Ferenc Gyurcsány', '2017-11-01', '2018-4-08')
    crawl_yun('Viktor Szigetvári', '2017-11-01', '2018-4-08')