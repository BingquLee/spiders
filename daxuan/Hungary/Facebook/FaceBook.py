...
if __name__ == '__main__':
    ViktorOrban_url = "https://www.facebook.com/pg/Viktor-Orban-808357069230023/posts/"
    GergelyKaracsony_url = "https://www.facebook.com/karacsonygergely/"
    GaborVona_url = "https://www.facebook.com/vonagabor/"
    BernadettSzel_url = "https://www.facebook.com/szelbernadett/"
    FerencGyurcsany_url = "https://www.facebook.com/gyurcsanyf/"
    ViktorSzigetvari_url = "https://www.facebook.com/SzigetvariViktor/"

    # crawl_facebook(ViktorOrban_url, '2017-11-01', '2018-04-08')
    # crawl_facebook(GergelyKaracsony_url, '2017-11-01', '2018-04-08')
    # crawl_facebook(GaborVona_url, '2017-11-01', '2018-04-08')
    crawl_facebook(ViktorSzigetvari_url, '2017-11-01', '2018-04-08')
    crawl_facebook(BernadettSzel_url, '2017-11-01', '2018-04-08')
    crawl_facebook(FerencGyurcsany_url, '2017-11-01', '2018-04-08')
try:
    pass
