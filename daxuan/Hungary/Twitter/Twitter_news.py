...
if __name__ == '__main__':
    # crawl_twitter('Angela Merkel')
    # crawl_twitter('Horst Seehofer')
    # crawl_twitter('Martin Schulz')
    # crawl_twitter('Sahra Wagenknecht')
    # crawl_twitter('Dietmar Bartsch')
    # crawl_twitter('Cem Özdemir')
    # crawl_twitter('Katrin Göring-Eckardt')
    # crawl_twitter('Christian Lindner')
    # crawl_twitter('Alexander Gauland')
    # crawl_twitter('Alice Weidel')
    crawl_twitter('Viktor Orbán')
    crawl_twitter('Gergely Karácsony')
    crawl_twitter('Gábor Vona')
    crawl_twitter('Bernadett Szél')
    crawl_twitter('Ferenc Gyurcsány')
    crawl_twitter('Viktor Szigetvári')
