...
if __name__ == '__main__':
    ...
    # crawl_yahoo('Conor Lamb', '2017-01-01')
    # crawl_yahoo('Drew Gray Miller', '2017-01-01')
    crawl_yahoo('Влади́мир Влади́мирович Пу́тин', '2017-10-01')
    crawl_yahoo('Ксе́ния Анато́льевна Собча́к', '2017-10-01')
    crawl_yahoo('Павел Гружинин', '2017-10-01')
    crawl_yahoo('Влади́мир Во́льфович Жирино́вский', '2017-10-01')
    crawl_yahoo('Алексе́й Анато́льевич Нава́льный', '2017-10-01')
