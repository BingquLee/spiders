...
if __name__ == '__main__':
    crawl_twitter('Влади́мир Влади́мирович Пу́тин')
    crawl_twitter('Ксе́ния Анато́льевна Собча́к')
    crawl_twitter('Павел Гружинин')
    crawl_twitter('Влади́мир Во́льфович Жирино́вский')
    crawl_twitter('Алексе́й Анато́льевич Нава́льный')
