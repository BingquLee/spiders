...
if __name__ == '__main__':
    ...
    # crawl_yun('Conor Lamb', '2017-01-01')
    # crawl_yun('Drew Gray Miller', '2017-01-01')
    crawl_yun('Влади́мир Влади́мирович Пу́тин', '2017-10-01', '2017-03-08')
    crawl_yun('Ксе́ния Анато́льевна Собча́к', '2017-10-01', '2017-03-08')
    crawl_yun('Павел Гружинин', '2017-10-01', '2017-03-08')
    crawl_yun('Влади́мир Во́льфович Жирино́вский', '2017-10-01', '2017-03-08')
    crawl_yun('Алексе́й Анато́льевич Нава́льный', '2017-10-01', '2017-03-08')