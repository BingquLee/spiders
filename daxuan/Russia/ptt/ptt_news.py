...
if __name__ == '__main__':
    crawl_ptt('Влади́мир Влади́мирович Пу́тин')
    crawl_ptt('Ксе́ния Анато́льевна Собча́к')
    crawl_ptt('Павел Гружинин')
    crawl_ptt('Влади́мир Во́льфович Жирино́вский')
    crawl_ptt('Алексе́й Анато́льевич Нава́льный')