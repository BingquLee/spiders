...
def crawl_facebook(url, start_strdate, end_strdate):
    ...
    id = con.xpath('//div[@id="u_0_f"]/a/text()')
    print id
...
if __name__ == '__main__':
    candidate1_url = "https://www.facebook.com/pg/Влади́мир-Влади́мирович-Пу́тин-623672394372480/posts/"
    # candidate2_url = "https://www.facebook.com/pg/Влади́мир-Влади́мирович-Пу́тин-623672394372480/posts/"
    # candidate3_url = ""

    crawl_facebook(candidate1_url, '2017-10-01', '2018-03-08')
