...
if __name__ == '__main__':
    # crawl_lianhe('文在寅', '2017-01-01', '2017-05-09')
    # crawl_lianhe('洪准杓', '2017-01-01', '2017-05-09')
    # crawl_lianhe('安哲秀', '2017-01-01', '2017-05-09')
    # crawl_lianhe('刘承旼', '2017-01-01', '2017-05-09')
    crawl_lianhe('沈相奵', '2017-01-01', '2017-05-09')
