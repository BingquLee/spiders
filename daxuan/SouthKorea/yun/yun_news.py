...
if __name__ == '__main__':
    ...
    crawl_yun('文在寅', '2017-01-01', '2017-05-09')
    crawl_yun('洪准杓', '2017-01-01', '2017-05-09')
    crawl_yun('安哲秀', '2017-01-01', '2017-05-09')
    crawl_yun('刘承旼', '2017-01-01', '2017-05-09')
    crawl_yun('沈相奵', '2017-01-01', '2017-05-09')