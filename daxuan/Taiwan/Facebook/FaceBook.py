...
def crawl_facebook(url, start_strdate):
    scroll_time = 300
    ...
    for x in range(1, i):
        ...
        if timestamp >= start_timest:
            ...
            item['timestamps'] = int(timestamp)
            item['date'] = date
            item['cn'] = "cn"
            item['content'] = Traditional2Simplified(txt)
            item['timesyear'] = timesyear
            item['time'] = stringDate
            item['id'] = Id

            item['per_favourity_count'] = zan
            item['comment'] = comm
            item['daily_count'] = {stringDate:zan}
            item['facebook_id'] = id
...
if __name__ == '__main__':
    ljl_url = "https://www.facebook.com/pg/forpeople/posts/"
    lxy_url = "https://www.facebook.com/pg/LuShiowYen/posts/"
    crawl_facebook(ljl_url, '2018-01-01')
    crawl_facebook(lxy_url, '2018-01-01')